...
public class SecurityConfig {
    ...
    private final List<String> excludedUrls = Arrays.asList("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/favicon.ico", "/api/reissue", "/api/member/login", "/api/healthcheck", "/api/oauth2/callback");
