package goorm.global.infra.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(GoormBusException.class)
    public ResponseEntity<ErrorResponse> handleFlowException(GoormBusException e) {
        log.error("GoormBusException caught - ErrorCode: {}, Message: {}",
    ...
    public ResponseEntity<ErrorResponse> handleJsonParseError(HttpMessageNotReadableException e) {
        ...
        if (rootCause instanceof GoormBusException babException) {
            return ResponseEntity
