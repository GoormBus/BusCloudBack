...
@Slf4j
public class GoormBusAuthExceptionFilter extends OncePerRequestFilter {
    ...
    private void handleFlowException(HttpServletResponse response, GoormBusException e) throws IOException {
        log.error("Filter에서 GoormBusException 발생 - ErrorCode: {}, Message: {}",
